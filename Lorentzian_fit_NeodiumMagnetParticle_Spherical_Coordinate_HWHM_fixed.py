...
############################## INITIAL PARAMETERS ##############################
p = [0.02, 0.02, 0.02, 0.02, P4, P5, P6]  
...
pl.rc('font', family='serif', size = 32)
pl.plot (x, yo, lw = 2, color = 'b', label = 'Experiment')
#pl.plot (x[dipind],y[dipind], 'ro')
pl.plot(x, fit, lw=2, color = 'k', label = r"Least-square fit") 
#pl.plot (x, Lor, lw = 1.5, color = 'g', label = r"NV1") #$\parallel [111]$")
#pl.plot (x, Lor8, lw = 1.5,  color = 'g')
#pl.plot (x, Lor2, lw = 1.5, color = 'y', label = r"NV2") #$\parallel [\bar{1} \bar{1} 1]$")
#pl.plot (x, Lor7, lw = 1.5, color = 'y')
#pl.plot (x, Lor3, lw = 1.5, color = 'c', label = r"NV3") #$\parallel [1 \bar{1} \bar{1}]$")
#pl.plot (x, Lor6, lw = 1.5, color = 'c')
#pl.plot (x, Lor4, lw = 1.5, color = 'm', label = r"NV4") #$\parallel [\bar{1} 1 \bar{1}]$")
#pl.plot (x, Lor5, lw = 1.5, color = 'm')
#pl.plot (x, Lorentzian)
pl.xlabel('Microwave frequency (GHz)', fontsize = 28)
pl.ylabel('Intensity (norm.)', fontsize = 28)

#pl.legend(loc=0, ncol=3, fontsize = 14)
pl.show()
