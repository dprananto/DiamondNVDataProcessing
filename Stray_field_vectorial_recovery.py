...
############################## INITIAL PARAMETERS ##############################
    p = [0.02, 0.02, 0.02, 0.02, P4, c[0], c[1], H]  # [dip 1-4, B0, Theta, Phi]
...
####################### WRITE DATAFRAME TO CSV ################################
    if (regionT == 1 and regionP == 1):
        if (best_parameters1[5] <= deg2 and best_parameters1[5] >= deg1 and best_parameters1[6] <= deg2 and best_parameters1[6] >= deg1):
            data_frame = {'PosX': [posX], 'PosY': [posY], 'PosZ': [posZ], 'B': [best_parameters1[4]], 'T': [best_parameters1[5]], 'P': [best_parameters1[6]], 'Bx': [Bx], 'By': [By], 'Bz': [Bz], 'Bi': [p[4]], 'Ti': [p[5]], 'Pi': [p[6]], 'D': [KS[0]], 'p-value': [KS[1]], 'iHWHM': [H], 'theta1': [t1], 'theta2': [t2], 'theta3': [t3], 'theta4': [t4], 'HWHM':[best_parameters1[7]]}
            df = pd.DataFrame(data_frame, columns = ['PosX', 'PosY', 'PosZ', 'B', 'T', 'P', 'Bx', 'By', 'Bz', 'Bi', 'Ti', 'Pi', 'D', 'p-value', 'iHWHM', 'theta1', 'theta2', 'theta3', 'theta4', 'HWHM'])
...
ro.columns = ['Index', 'PosX', 'PosY', 'PosZ', 'B', 'T', 'P', 'Bx', 'By', 'Bz', 'Bi', 'Ti', 'Pi', 'D', 'p-value', 'iHWHM', 'theta1', 'theta2', 'theta3', 'theta4', 'HWHM']
